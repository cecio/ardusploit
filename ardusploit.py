...
#
# $Id: ardusploit.py,v 2.10 2017/05/12 20:14:15 cesare Exp cesare $
#
# Notes: 
#
# Dump code examples:
#       /opt/arduino-1.8.2/hardware/tools/avr/bin/avrdude -C/opt/arduino-1.8.2/hardware/tools/avr/etc/avrdude.conf -q -patmega328p -carduino -P/dev/ttyACM0 -b115200 -D -Uflash:r:/tmp/flash.hex:i
#       /opt/arduino-1.8.2/hardware/tools/avr/bin/avrdude -C/opt/arduino-1.8.2/hardware/tools/avr/etc/avrdude.conf -q -patmega32u4 -cavr109 -P/dev/ttyACM0 -b57600 -D -Uflash:r:/tmp/flash.hex:i
#       /opt/arduino-1.8.2/hardware/tools/avr/bin/avrdude -C/opt/arduino-1.8.2/hardware/tools/avr/etc/avrdude.conf -q -patmega2560 -cwiring -P/dev/ttyUSB0 -b115200 -D -Uflash:r:/tmp/flash.hex:i
#
...
# insertPointFlag = '80937A00'     # atmega32u4
...
def injectHex(ifile, verbose, dryrun, payloadAddr, initPayloadAddr):
	...
	global initcode, payloadDictionary, mcu
...
def main(argv):
	...
	try:
		opts, args = getopt.getopt(argv,"?hdf:vm:i:p:P:",["dry-run","ifile=","verbose","mcu=","insert-flag=","payload-addr=","init-payload-addr="])
	...
	for opt, arg in opts:
		if opt == '-h' or opt == '-?':
			...
			print '              -m specify MCU to work with'
	...
	if inputfile:		
		print '[+] Running for MCU: ' + mcu + ' with insert-flag: ' + insertPointFlag
